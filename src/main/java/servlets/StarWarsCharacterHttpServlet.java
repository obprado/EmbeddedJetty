...
public class StarWarsCharacterHttpServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        CloseableHttpResponse lukeResponse = FireAGetRequestTo("http://localhost:8888/api/people/1/");
        ...
        String lukeSpecies = extractName(FireAGetRequestTo(lukeJsonDocument.read("$.species[0]")));
        String lukeHomeworld = extractName(FireAGetRequestTo(lukeJsonDocument.read("$.homeworld")));
    ...
    private CloseableHttpResponse FireAGetRequestTo(String uri) throws IOException {
